...
export class Contract {
        ...
        this.circuits = {
            open_voting: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('open_voting', 'argument 1 (as invoked from Typescript)', 'voting.compact line 12 char 1', 'CircuitContext', contextOrig_0);
                }
            ...
            close_voting: (...args_1) => {
                ...
                const contextOrig_0 = args_1[0];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('close_voting', 'argument 1 (as invoked from Typescript)', 'voting.compact line 17 char 1', 'CircuitContext', contextOrig_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: { value: [], alignment: [] },
            ...
            vote: (...args_1) => {
                ...
                const contextOrig_0 = args_1[0];
                const voter_id_0 = args_1[1];
                const choice_0 = args_1[2];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('vote', 'argument 1 (as invoked from Typescript)', 'voting.compact line 22 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(voter_id_0.buffer instanceof ArrayBuffer && voter_id_0.BYTES_PER_ELEMENT === 1 && voter_id_0.length === 32)) {
                    __compactRuntime.typeError('vote', 'argument 1 (argument 2 as invoked from Typescript)', 'voting.compact line 22 char 1', 'Bytes<32>', voter_id_0);
                }
                if (!(typeof (choice_0) === 'boolean')) {
                    __compactRuntime.typeError('vote', 'argument 2 (argument 3 as invoked from Typescript)', 'voting.compact line 22 char 1', 'Boolean', choice_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
                        value: _descriptor_1.toValue(voter_id_0).concat(_descriptor_0.toValue(choice_0)),
                ...
                const result_0 = this._vote_0(context, partialProofData, voter_id_0, choice_0);
                partialProofData.output = { value: [], alignment: [] };
                return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
            }
        };
    ...
    _vote_0(context, partialProofData, voter_id_0, choice_0) {
        ...
        const disclosed_voter_id_0 = voter_id_0;
        const disclosed_choice_0 = choice_0;
        __compactRuntime.assert(!_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
            { dup: { n: 0 } },
            { idx: { cached: false,
                    pushPath: false,
            ...
            { push: { storage: false,
                    value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(disclosed_voter_id_0),
        ...
        if (disclosed_choice_0) {
            ...
            __compactRuntime.queryLedgerState(context, partialProofData, [
                ...
                { addi: { immediate: parseInt(__compactRuntime.valueToBigInt({ value: _descriptor_2.toValue(tmp_0),
            ...
            __compactRuntime.queryLedgerState(context, partialProofData, [
                ...
                { addi: { immediate: parseInt(__compactRuntime.valueToBigInt({ value: _descriptor_2.toValue(tmp_1),
                            alignment: _descriptor_2.alignment() }
                            .value)) } },
                { ins: { cached: true, n: 1 } }
            ]);
        ...
        voters: {
            ...
            member(...args_0) {
                ...
                if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
                    __compactRuntime.typeError('member', 'argument 1', 'voting.compact line 8 char 1', 'Bytes<32>', elem_0);
                }
                return _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
